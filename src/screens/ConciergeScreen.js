...
const s = StyleSheet.create({
  ...
  threadChipT: { color: C.mut, fontSize: 13, fontFamily: T.sansM },
  ...
  aiLabelT: { color: C.gold, fontSize: 10, fontFamily: T.sansB, letterSpacing: T.trackWide },
  chipsInline: {
  ...
  resumeT: { fontFamily: T.garamondI, fontSize: 16, lineHeight: 22, color: C.mut, fontStyle: "italic" },
  ...
  resumeYesT: { fontFamily: T.sansB, fontSize: 13, color: C.inkD },
  resumeNo: { flex: 1, borderWidth: 1, borderColor: C.line, borderRadius: 10, paddingVertical: 11, alignItems: "center" },
  resumeNoT: { fontFamily: T.sansM, fontSize: 13, color: C.mut },
  ...
  placeName:   { color: C.ink, fontSize: 15, fontFamily: T.sansB, flex: 1, marginRight: 8 },
  placeAddr:   { color: C.mut, fontSize: 13, fontFamily: T.sans },
  placeRating: { color: C.gold, fontSize: 13, fontFamily: T.sansM },
  ...
  placeMapLink: { color: C.gold, fontSize: 13, fontFamily: T.sansM },
  ...
  actionBtnT: { color: C.inkD, fontSize: 15, fontFamily: T.sansB, letterSpacing: 0.5 },
  ...
  transitIcon:   { fontSize: 22, marginTop: 2 },
  transitTitle:  { color: C.ink, fontSize: 15, fontFamily: T.sansB },
  transitMeta:   { color: C.gold, fontSize: 13, fontFamily: T.sansM, marginTop: 2 },
  transitStep:   { flexDirection: "row", gap: 8, paddingVertical: 4, borderTopWidth: 0.5, borderTopColor: "rgba(201,169,110,0.1)" },
  transitStepMode: { fontSize: 15, width: 22, textAlign: "center", marginTop: 2 },
  transitStepText: { color: C.ink, fontSize: 13, fontFamily: T.sans, lineHeight: 20 },
  transitStepDetail: { color: C.gold, fontSize: 13, fontFamily: T.sansM, marginTop: 2 },
  ...
  transitTicketBtnT: { color: C.gold, fontSize: 13, fontFamily: T.sansM },

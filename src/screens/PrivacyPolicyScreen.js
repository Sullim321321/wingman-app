...
const s = StyleSheet.create({
  ...
  headerTitle: { color: C.ink, fontSize: 18, fontFamily: T.sansB, marginLeft: "auto", marginRight: "auto", paddingRight: 40 },
  scroll: { padding: 24, paddingBottom: 80 },
  title: { color: C.ink, fontSize: 28, fontFamily: T.serifB, marginBottom: 16 },
  ...
  sectionTitle: { color: C.ink, fontSize: 20, fontFamily: T.serifB, marginBottom: 16 },

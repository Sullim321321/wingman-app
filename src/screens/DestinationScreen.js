...
const makeStyles = (C) => ({
  ...
  backT:          { color: C.gold, fontSize: 30, lineHeight: 32 },
  headerCity:     { fontSize: 30, color: C.ink },
  headerTrip:     { color: C.mut, fontSize: 13, fontFamily: T.sans, marginTop: 2 },
  center:         { flex: 1, alignItems: "center", justifyContent: "center", padding: 32 },
  loadingT:       { color: C.mut, fontSize: 13, fontFamily: T.sans, marginTop: 16, textAlign: "center" },
  errorT:         { color: C.coral, fontSize: 15, fontFamily: T.sans, textAlign: "center", marginBottom: 16 },
  retry:          { color: C.gold, fontSize: 15, fontFamily: T.sansB },
  scroll:         { paddingHorizontal: 20, paddingTop: 20 },
  headline:       { fontSize: 22, color: C.ink, lineHeight: 28, marginBottom: 20 },
  ...
  weatherBody:    { color: C.ink, fontSize: 15, fontFamily: T.sans, lineHeight: 20 },
  weatherBest:    { color: C.mut, fontSize: 13, fontFamily: T.sans, marginTop: 6 },
  // Neighborhoods
  ...
  mustOrder:      { color: C.gold, fontSize: 13, fontFamily: T.sansM, marginTop: 8 },
  // Pill
  pill:           { borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1 },
  pillT:          { fontSize: 10, fontFamily: T.sansB, letterSpacing: 0.8 },
  // Tips
  ...
  // Concierge prompts
  conciergeHint:  { color: C.mut, fontSize: 13, fontFamily: T.sans, marginBottom: 10 },
  ...
  conciergeArrow: { color: C.gold, fontSize: 16, marginLeft: 8 },
});

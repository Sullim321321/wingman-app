...
const s = StyleSheet.create({
  ...
  backBtnT:{ color: C.ink, fontSize: 30, fontFamily: T.sans },
  headerCenter: { flex: 1, alignItems: "center" },
  headerTitle: { color: C.ink, fontSize: 16 },
  ...
  saveBtnT:{ color: C.gold, fontSize: 15, fontFamily: T.sansB },
  ...
  cardInfo:   { flex: 1 },
  cardName:   { color: C.ink, fontSize: 15, fontFamily: T.sansM },

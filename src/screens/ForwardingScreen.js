...
const s = StyleSheet.create({
  ...
  label: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 2.4, color: C.mutD, marginBottom: 10 },
  ...
  copyT: { fontFamily: T.sansB, fontSize: 15, color: C.inkD },
  warn: { fontFamily: T.sansM, fontSize: 11, lineHeight: 17, color: C.mut, marginTop: 14 },
  err: { fontFamily: T.sansM, fontSize: 13, color: C.coral },

  sectionH: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 2.4, color: C.mutD, marginBottom: 8 },
  sectionSub: { fontFamily: T.garamondI, fontSize: 16, lineHeight: 22, color: C.mut, marginBottom: 22 },
  ...
  stepNT: { fontFamily: T.garamond, fontSize: 13, color: C.gold },
  stepT: { fontFamily: T.sansM, fontSize: 15, color: C.ink, marginBottom: 4 },
  stepD: { fontFamily: T.sans, fontSize: 13, lineHeight: 20, color: C.mut },

  code: { backgroundColor: C.card2, borderWidth: 1, borderColor: C.line, borderRadius: 10,
          padding: 12, marginTop: 10 },
  codeT: { fontFamily: T.sans, fontSize: 11, lineHeight: 17, color: C.mut },
  codeC: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 1.4, color: C.gold, marginTop: 8 },

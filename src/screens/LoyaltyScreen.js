...
const ps = StyleSheet.create({
  ...
  summaryNum: { color: C.ink, fontSize: 20, fontWeight: "700" },
  ...
  progName: { color: C.ink, fontSize: 15, fontWeight: "700" },
  ...
  actionBtnText: { color: C.teal, fontSize: 12, fontWeight: "600" },
  empty: { alignItems: "center", paddingHorizontal: 32, paddingVertical: 40 },
  emptyIcon: { fontSize: 48, marginBottom: 16 },
  emptyTitle: { color: C.ink, fontSize: 18, fontWeight: "700", marginBottom: 10, textAlign: "center" },
  ...
  addBtnText: { color: "#0A0E1C", fontSize: 15, fontWeight: "700" },
  ...
  kindHeader: { color: C.mut, fontSize: 11, fontWeight: "700", letterSpacing: 1, marginTop: 16, marginBottom: 8 },
  ...
  selectedProgName: { color: C.ink, fontSize: 18, fontWeight: "700" },
  fieldLabel: { color: C.mut, fontSize: 12, fontWeight: "600", letterSpacing: 0.5, marginBottom: 6, marginTop: 16 },
  ...
  connectBtnText: { color: "#0A0E1C", fontSize: 15, fontWeight: "700" },
});

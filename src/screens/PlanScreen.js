...
const s = StyleSheet.create({
  ...
  back: { color: C.mut, fontSize: 30, lineHeight: 28, width: 22 },
  barMid: { flexDirection: "row", alignItems: "center", gap: 8 },
  barT: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 2.6, color: C.gold },
  count: { fontFamily: T.sansM, fontSize: 13, color: C.mut, width: 22, textAlign: "right" },
  ...
  pasteT:    { fontFamily: T.sans, fontSize: 13, color: C.mut, lineHeight: 20 },
  openOr:    { fontFamily: T.sansB, fontSize: 10, letterSpacing: 2, color: C.mutD, marginTop: 24, marginBottom: 2 },
  ...
  meT: { fontFamily: T.sansM, fontSize: 15, lineHeight: 21, color: C.ink },

  wm: { maxWidth: "94%", marginBottom: 18 },
  wmHead: { flexDirection: "row", alignItems: "center", gap: 7, marginBottom: 7 },
  wmName: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 2.2, color: C.gold },
  ...
  blockH: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 2.6, color: C.mutD, marginBottom: 10 },
  blockSub: { fontFamily: T.garamondI, fontSize: 15, lineHeight: 20, color: C.mut, marginBottom: 14 },

  pro: { borderWidth: 1, borderColor: "rgba(212,144,42,0.4)", borderRadius: 12, padding: 14, marginBottom: 10 },
  proT: { fontFamily: T.sansM, fontSize: 15, lineHeight: 20, color: C.ink, marginBottom: 10 },
  ...
  srcLink: { fontFamily: T.sansM, fontSize: 11, color: C.teal, marginBottom: 10 },
  ...
  legT: { fontFamily: T.sansM, fontSize: 15, color: C.ink, flex: 1 },
  legTag: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 1.4, color: C.gold, opacity: 0.75 },
  legWhy: { fontFamily: T.garamondI, fontSize: 15, lineHeight: 19, color: C.mut,
  ...
  standingT: { fontFamily: T.sans, fontSize: 13, color: C.mut, flex: 1, paddingRight: 8 },
  ...
  cT: { fontFamily: T.sansM, fontSize: 15, lineHeight: 20, color: C.ink },
  cMeta: { flexDirection: "row", flexWrap: "wrap", gap: 5, marginTop: 4 },
  cHard: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 1.3 },
  cScope: { fontFamily: T.sansM, fontSize: 11, color: C.gold },
  cSrc: { fontFamily: T.sansM, fontSize: 11, color: C.teal },
  cExp: { fontFamily: T.sansM, fontSize: 11, color: C.amber },

  gaps: { fontFamily: T.garamondI, fontSize: 15, color: C.mut, marginTop: 14 },
  ...
  sendT: { fontSize: 22, color: C.inkD, fontWeight: "700", lineHeight: 22 },
});

...
const makeStyles = (C) => ({
  ...
  stdHard: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 1.2, color: C.mut, marginTop: 3 },
  stdBot:  { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 10 },
  stdSrc:  { fontFamily: T.sans, fontSize: 13, color: C.mut, flex: 1, paddingRight: 10 },
  stdX:    { fontFamily: T.sansM, fontSize: 13, color: C.coral },
  ...
  introBody:  { fontFamily: T.sans, fontSize: 15, color: C.mut, lineHeight: 20 },
  updatedAt:  { fontFamily: T.sans, fontSize: 13, color: C.mut + "80", marginTop: 8 },
  ...
  emptyBody:   { fontFamily: T.sans, fontSize: 15, color: C.mut, lineHeight: 20, marginBottom: 12 },
  ...
  fieldEmpty:   { fontFamily: T.sans, fontSize: 15, color: C.mut + "60", fontStyle: "italic" },
  ...
  miscText:     { flex: 1, fontFamily: T.sans, fontSize: 15, color: C.parchment, lineHeight: 20 },
  miscRemove:   { paddingLeft: 12, paddingTop: 2 },
  miscRemoveT:  { fontFamily: T.sans, fontSize: 15, color: C.mut },

  footer:       { marginHorizontal: 20, marginTop: 28, paddingTop: 16, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: C.line },
  footerText:   { fontFamily: T.sans, fontSize: 13, color: C.mut + "80", lineHeight: 18, textAlign: "center" },
});

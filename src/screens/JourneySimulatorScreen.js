...
const s = StyleSheet.create({
  ...
  errorT:         { color: C.mut, fontSize: 15, fontFamily: T.sans, marginBottom: 16 },
  ...
  title:          { color: C.ink, fontSize: 30, marginBottom: 4 },
  ...
  statLabel:      { color: C.mut, fontSize: 10, fontFamily: T.sansB, letterSpacing: 1.2, marginBottom: 4 },
  statValue:      { color: C.ink, fontSize: 16, fontFamily: T.serifB },
  statNote:       { color: C.mut, fontSize: 10, fontFamily: T.sans, marginTop: 2, textAlign: "center" },

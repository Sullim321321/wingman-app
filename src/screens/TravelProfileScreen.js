...
const makeStyles = (C) => ({
  ...
  title:          { color: C.ink, fontSize: 30, marginBottom: 6 },
  subtitle:       { color: C.mut, fontSize: 13, fontFamily: T.sans, lineHeight: 19 },
  sectionHeader:  { marginTop: 20, marginBottom: 8 },
  sectionTitle:   { color: C.ink, fontSize: 15, fontFamily: T.sansB, letterSpacing: 0.3 },
  sectionSub:     { color: C.mut, fontSize: 13, fontFamily: T.sans, marginTop: 2 },
  ...
  input:          { flex: 1, backgroundColor: C.bg, borderRadius: 10, padding: 10, borderWidth: 1, borderColor: C.line, color: C.ink, fontSize: 15, fontFamily: T.sans },

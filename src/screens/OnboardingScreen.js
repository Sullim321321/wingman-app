...
const s = StyleSheet.create({
  ...
  // Sign-up slide
  signUpCard: { width: "100%", borderRadius: 24, borderWidth: 1, borderColor: C.line, overflow: "hidden", padding: 20, backgroundColor: "rgba(15,13,10,0.92)" },
  permGlow:   { position: "absolute", top: 0, left: 0, right: 0, height: 100 },
  permIconWrap: { alignItems: "center", marginBottom: 16 },
  permIconBg: { width: 60, height: 60, borderRadius: 18, alignItems: "center", justifyContent: "center" },
  permIconText: { fontSize: 24, fontFamily: T.sansB },
  permTitle:  { color: C.ink, fontSize: 24, marginBottom: 8, textAlign: "center" },
  permBody:   { color: C.mut, fontSize: 14, fontFamily: T.sans, textAlign: "center", lineHeight: 21, marginBottom: 20 },
  authOptions:{ gap: 12, width: "100%" },
  appleBtn:   { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF", borderRadius: 14, paddingVertical: 14, gap: 8 },
  ...
  emailBtn:   { borderWidth: 1, borderColor: C.line, borderRadius: 14, paddingVertical: 14, alignItems: "center" },
  emailBtnT:  { color: C.ink, fontSize: 15, fontFamily: T.sansM },
  signUpInput:{ backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: C.line, color: C.ink, fontSize: 16, fontFamily: T.sans, width: "100%" },

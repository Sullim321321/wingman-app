      ...
      <View style={ps.balanceRow}>
        <View style={ps.balanceBlock}>
          {hasBalance ? (
            ...
            <>
              <Text style={[ps.balanceNum, { color: C.mut, fontSize: 16 }]}>—</Text>
...
const makeIns = (C) => ({
  ...
  title: { fontFamily: T.sansM, fontSize: 15, flex: 1, lineHeight: 19 },
...
const makePs = (C) => ({
  ...
  memberName: { color: C.mut, fontSize: 13, marginTop: 2, fontFamily: T.sans },
  ...
  balanceBlock: {},
  balanceNum: { color: C.ink, fontSize: 30, fontFamily: T.sansB, letterSpacing: -0.5 },
  balanceLabel: { color: C.mut, fontSize: 11, marginTop: 3, fontFamily: T.sans },
  addBalanceHint: { color: C.gold, fontSize: 13, fontFamily: T.sansM, marginTop: 4 },
  ...
  expiryText: { color: C.gold, fontSize: 13, fontFamily: T.sans },
  ...
  actionBtnText: { color: C.gold, fontSize: 13, fontFamily: T.sansM },
  empty: { alignItems: "center", paddingHorizontal: 32, paddingVertical: 40 },
  emptyIcon: { fontSize: 48, marginBottom: 16 },
  emptyTitle: { color: C.ink, fontSize: 22, fontFamily: T.sansB, marginBottom: 10, textAlign: "center" },
  emptySub: { color: C.mut, fontSize: 15, lineHeight: 22, textAlign: "center", fontFamily: T.sans },
  ...
  modalTitle: { color: C.ink, fontSize: 16, fontFamily: T.sansB },
  modalClose: { color: C.mut, fontSize: 22 },
  modalScroll: { padding: 20, paddingBottom: 60 },
  modalSub: { color: C.mut, fontSize: 15, marginBottom: 20 },
  ...
  progRowArrow: { color: C.mut, fontSize: 16 },
  backLink: { marginBottom: 16 },
  backLinkText: { color: C.gold, fontSize: 15 },
  selectedProg: { flexDirection: "row", alignItems: "center", marginBottom: 24 },
  selectedProgIcon: { fontSize: 34, marginRight: 12 },
  selectedProgName: { color: C.ink, fontSize: 16, fontFamily: T.sansB },
  ...
  statusPickerText: { color: C.ink, fontSize: 15 },
  ...
  privacyNoteText: { color: C.mut, fontSize: 13, lineHeight: 18 },
  ...
  credentialsNote: { color: C.mut, fontSize: 13, lineHeight: 18, marginBottom: 14 },

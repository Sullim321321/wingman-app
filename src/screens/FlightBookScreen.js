...
const makeStyles = (C) => ({
  ...
  summaryTime: { color: C.mut, fontSize: 13, marginTop: 2 },
  summaryDur: { color: C.mut, fontSize: 13 },
  ...
  summaryPriceVal: { color: C.teal, fontSize: 22, fontFamily: T.sansB },
  group: { backgroundColor: C.card, borderWidth: 1, borderColor: C.line, borderRadius: 16, padding: 14 },
  fieldWrap: { marginBottom: 14 },
  fieldLabel: { color: C.mut, fontSize: 11, fontFamily: T.sansB, letterSpacing: 1, marginBottom: 6 },
  field: { color: C.ink, fontSize: 15, borderBottomWidth: 1, borderBottomColor: C.line, paddingBottom: 8 },
  genderBtn: { flex: 1, paddingVertical: 10, borderRadius: 10, backgroundColor: C.card2, borderWidth: 1, borderColor: C.line, alignItems: "center" },
  genderBtnSel: { backgroundColor: C.confirmedFill, borderColor: C.teal },
  genderT: { color: C.mut, fontSize: 15, fontFamily: T.sansM },
  ...
  noticeT: { color: C.amber, fontSize: 13 },

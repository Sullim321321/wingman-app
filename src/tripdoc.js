...
const makeStyles = (C) => ({
  ...
  legName:{ fontFamily: T.sansM, fontSize: 16, color: C.ink, flex: 1, paddingRight: 8 },
  sketchTag: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 1.6, color: C.mutD, marginTop: 3 },
  legWhen:{ fontFamily: T.mono, fontSize: 11, color: C.mut, marginTop: 7, letterSpacing: 0.3 },
  legWhy: { fontFamily: T.garamondI, fontStyle: "italic", fontSize: 15, color: C.mut, marginTop: 6, lineHeight: 20 },
  ...
  depText: { fontFamily: T.sans, fontSize: 13, color: C.mut, flex: 1, lineHeight: 18 },
  depSlack:{ fontFamily: T.monoM, fontSize: 11, letterSpacing: 0.3 },
  depGuess:{ fontFamily: T.sans, fontSize: 11, color: C.mutD, fontStyle: "italic" },

  rides: { fontFamily: T.sans, fontSize: 13, color: C.mutD, marginTop: 2, marginLeft: 2 },
  dismiss: { fontFamily: T.sansM, fontSize: 13, color: C.coral, marginTop: 1 },
  remove:  { fontFamily: T.sansM, fontSize: 13, color: C.mutD, marginTop: 1 },
});

      ...
      if (result?.ok || result?.booking || result?.booked) {
        Alert.alert(
          ...
          result.booking_reference
            ? `You're rebooked. Reference: ${result.booking_reference} — confirmation is on its way to your email.`
            : "You're rebooked. Confirmation is on its way to your email — nothing else you need to do.",
      ...
      <SafeAreaView style={s.root}>
        <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
          ...
          <Pressable style={s.missedOption} onPress={() => handleConcierge(`I missed my ${ident || "flight"} from ${flight?.origin || "origin"} to ${flight?.destination || "destination"}. What are the next available flights and what are my rights?`)}>
            ...
            <Text style={s.missedOptionSub}>I'll search alternatives and check what you're owed</Text>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        {connectionRisk && (
          <View style={[s.connectionRisk, {
            ...
            <Text style={s.connectionRiskSub}>
              {connectionRisk.level === "MISSED"
                ? "Your connection's gone — I'm already finding alternatives for the whole journey."
                : "It's a very tight connection. I've lined up rebooking options for the whole journey below."}
            </Text>
          </View>
        )}
          ...
          <>
            ...
            {selectedAlt && (
              <Pressable style={s.bookBtn} onPress={() => { tap(); setShowConfirm(true); }}>
                <Text style={s.bookBtnT}>Rebook me on this  →</Text>
              </Pressable>
            )}
          </>
        )}
        ...
        {alternatives.length === 0 && (
          ...
          >
            ...
            <Text style={s.conciergeTitle}>Let me find your options</Text>
            <Text style={s.conciergeSub}>I'll search alternatives, check what you're owed, and rebook for you.</Text>

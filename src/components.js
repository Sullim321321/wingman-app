// Wingman Shared Components — Quiet Luxury / Editorial
...
export function Btn({ title, onPress, kind = "primary", style }) {
  ...
  // "accent" = teal (used for confirmation), "primary" = champagne gold
  const grad = kind === "accent" ? ["#2DB896", "#1E9B7A"] : [C.gold, C.goldD];
...
// ─── Settings row ─────────────────────────────────────────────────────────────
// ic: hairline Unicode symbol string, iconColor: C.gold or similar
...
export const g = StyleSheet.create({
  ...
  backLabel:  { color: C.mut, fontSize: 13, fontFamily: T.sans },
  ...
  segOn:  { backgroundColor: C.card2, borderWidth: 1, borderColor: C.line },
  segT:   { color: C.mut, fontSize: 12, fontFamily: T.sansM, letterSpacing: 0.3 },
  segTOn: { color: C.ink, fontFamily: T.sansB },

  // Settings row
  setRow: { flexDirection: "row", alignItems: "center", gap: 14, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: C.line },
  setIc:  { width: 34, height: 34, borderRadius: 10, backgroundColor: C.card2, borderWidth: 1, borderColor: C.line, alignItems: "center", justifyContent: "center" },
  ...
  // Group container
  group: { backgroundColor: C.card, borderWidth: 1, borderColor: C.line, borderRadius: 18, paddingHorizontal: 16 },
  ...
  // Option card
  opt:      { backgroundColor: C.card, borderWidth: 1, borderColor: C.line, borderRadius: 18, padding: 16, marginBottom: 12 },
  optSel:   { borderColor: C.gold, backgroundColor: C.gold + "0A", borderWidth: 1.5 },
  ...
  // Reason card
  rcard:  { backgroundColor: C.card, borderWidth: 1, borderColor: C.line, borderRadius: 18, padding: 18, marginBottom: 14 },
  ...
  execH:    { color: C.ink, fontSize: 22, letterSpacing: T.trackTight, marginBottom: 6 },

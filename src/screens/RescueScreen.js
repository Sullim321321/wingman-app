...
const s = StyleSheet.create({
  ...
  owedT:   { fontFamily: T.sansM, fontSize: 15, color: C.ink },
  owedAmt: { fontFamily: T.monoM, fontSize: 15, color: C.gold, letterSpacing: 0.5 },
  owedWhy: { fontFamily: T.sans, fontSize: 13, color: C.mut, lineHeight: 18, marginTop: 6 },
  owedHow: { fontFamily: T.sans, fontSize: 13, color: C.mutD, lineHeight: 17, marginTop: 6 },
  owedLink:{ fontFamily: T.sansM, fontSize: 13, color: C.gold, marginTop: 11 },
  ...
  noRecH: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 2.2, color: C.amber },
  noRecT: { fontFamily: T.sans, fontSize: 15, lineHeight: 21, color: C.ink },
  ...
  rankT: { fontFamily: T.garamond, fontSize: 13, color: C.gold },
  carrier: { fontFamily: T.sansB, fontSize: 16, color: C.ink },
  meta: { fontFamily: T.sansM, fontSize: 13, color: C.mut, marginTop: 3, textTransform: "capitalize" },
  recTag: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 1.4, color: C.gold },

  rule: { height: 1, backgroundColor: C.line, marginVertical: 13 },

  line: { flexDirection: "row", gap: 10, marginBottom: 9 },
  lineK: { fontFamily: T.sansB, fontSize: 10, letterSpacing: 1.3, width: 46, marginTop: 3 },
  lineV: { flex: 1, fontFamily: T.sansM, fontSize: 13, lineHeight: 19, color: C.ink },
  lineWhy: { fontFamily: T.garamondI, fontSize: 13, lineHeight: 19, color: C.mut,
  ...
  altT: { fontFamily: T.sansM, fontSize: 13, color: C.gold },

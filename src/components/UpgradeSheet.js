...
const s = StyleSheet.create({
  ...
  title: { fontFamily: T.garamondSI, fontSize: 30, color: C.ink, lineHeight: 34, marginBottom: 8 },
  body: { fontFamily: T.sans, fontSize: 15, lineHeight: 21, color: C.mut, marginBottom: 20 },
  benefits: { gap: 10, marginBottom: 24 },
  benefitRow: { flexDirection: "row", alignItems: "center", gap: 9 },
  benefitT: { fontFamily: T.sansM, fontSize: 15, color: C.mut },
  ...
  laterT: { fontFamily: T.sansM, fontSize: 15, color: C.mut },
});

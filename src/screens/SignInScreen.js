...
const makeStyles = (C) => ({
  ...
  markIcon:   { color: C.inkD, fontSize: 30, fontFamily: T.sansB },
  h:          { color: C.ink, fontSize: 30, marginBottom: 6 },
  sub:        { color: C.mut, fontSize: 15, fontFamily: T.sans, marginBottom: 24 },
  ...
  authIconText: { fontSize: 16 },
  authInfo:   { flex: 1 },
  authTitle:  { color: C.ink, fontSize: 15, fontFamily: T.sansM },
  authSub:    { color: C.mut, fontSize: 13, fontFamily: T.sans, marginTop: 2 },
  authChev:   { color: C.mut, fontSize: 22, fontFamily: T.sans },

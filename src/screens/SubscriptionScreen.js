...
const s = StyleSheet.create({
  ...
  backBtnT: { color: C.teal, fontSize: 15, fontFamily: T.sansM },
  ...
  featureCheck: { fontSize: 15, fontFamily: T.sansB, width: 16 },
  ...
  footerT: { color: C.mut, fontSize: 13, textAlign: "center", lineHeight: 17 },
});

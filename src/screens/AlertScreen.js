        ...
        <ScrollView contentContainerStyle={g.scroll}>
          ...
          <View style={s.emptyWrap}>
            ...
            <Text style={s.emptyBody}>
              Add a trip with at least one flight, and I'll watch it for delays, cancellations, and gate changes — with rescue options ready here if anything goes wrong.
            </Text>
            <Btn
              title="+ Add a trip"
              kind="primary"
      ...
      <ScrollView contentContainerStyle={g.scroll}>
            ...
            {rescueData.options.filter(o => o.type === "points").length > 0 && (
              <>
                ...
                <Text style={s.pointsNote}>
                  I'll transfer your points and book the seat — one tap, no hold music.
                </Text>
        ...
        {rescueData?.downstream_legs_detail?.length > 0 && (
          <>
            ...
            <Text style={s.rescueNote}>
              I'll draft and send a note to each affected reservation on your behalf.
            </Text>
              ...
              <View style={s.approveBtnInner}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={[s.approveBtnT, { color: C.ink }]}>
                    {accepting ? "Handling it…" : "Rebook me"}
                  </Text>
